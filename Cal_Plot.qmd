...
```
Let's break down what this function does. The first line `group_tsplot <- function(data,group,title,ylab)` indicates our function requires 4 inputs: `data`, `group`, `title`, and `ylab`. 
