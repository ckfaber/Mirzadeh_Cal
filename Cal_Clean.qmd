...
if (file.exists(savename)) {
  go <- menu(c("Yes","No"), title = "A .Rda file for this file already exists. Re-run this script and overwrite?")
}

if (go == 2) {
    print(paste("Aborting script, Clean.Rda file for this run already exists. "))
}
```
...
df              <- read_csv(paste(fpath,paste(fname,".csv",sep = ""),sep="/")) %>%
